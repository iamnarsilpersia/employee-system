<nav>
    <ul class="metismenu" id="menu">
        <li class="<?php if($page=='dashboard') {echo 'active';} ?>"><a href="dashboard.php"><i class="ti-dashboard"></i> <span>Payroll</span></a></li>
        <li class="<?php if($page=='deductions') {echo 'active';} ?>"><a href="deductions.php"><i class="ti-money"></i> <span>Deductions</span></a></li>
